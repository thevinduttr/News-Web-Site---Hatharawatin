            ...
            <div class="col-md-4">
               <div class="card-box h-100">
                  <div class="card-header">
                     <h2 class="card-title mb-2">Welcome NexCodia Software Solutions.</h2>
                     <span class="d-block mb-4 text-nowrap">Sri Lanka</span>
                  </div>
                  <br><br>
                  <div class="card-body">
                     <div class="row ">
                        <div class="col-md-6">
                           ...
                           <small class="d-block mb-3">In <br> Html , CSS ,PHP, PDO,  Python, Laravel</small>
                           <br>
                           <br>
                           <a href="https://nexcodia.com/" target="a_blank" class="btn btn-sm btn-primary">Visit Website</a>
                        </div>
                        <div class="col-md-6">
